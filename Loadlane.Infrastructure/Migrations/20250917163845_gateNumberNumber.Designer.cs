...
namespace Loadlane.Infrastructure.Migrations
{
    ...
    [Migration("20250917163845_gateNumberNumber")]
    partial class gateNumberNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Loadlane.Domain.Entities.Waypoint", b =>
                {
                    b.HasOne("Loadlane.Domain.Entities.Gate", "Gate")
                        .WithMany()
                        .HasForeignKey("GateId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_waypoints_gates_gate_id");
